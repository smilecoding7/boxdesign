...
$jsn1=$row['outjsn'];
$rr= html_entity_decode($jsn1);

//$jsn1dec=json_decode($jsn1,true);
$jsn2=$row['injsn'];
...
<input type="text" id="myTextArea" name="myyjson" style="position:absolute;z-index:23000;width:90%; bottom:200px" value="<?php  $myfile ?>"/>
<input type="text" id="myTextArea" name="myyjson" style="position:absolute;z-index:23000;width:90%; bottom:100px" value="<?php  $myfilein ?>"/>
