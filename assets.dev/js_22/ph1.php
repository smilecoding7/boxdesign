...
<!--
    ...
    https://cdnjs.cloudflare.com/ajax/libs/FileSaver.js/2.0.0/FileSaver.min.js.map

// this down for blob
    https://cdnjs.cloudflare.com/ajax/libs/javascript-canvas-to-blob/3.28.0/js/canvas-to-blob.min.js


    https://cdnjs.cloudflare.com/ajax/libs/javascript-canvas-to-blob/3.28.0/js/canvas-to-blob.js
-->
...
$('#ssaavvee2').click(function(){

// $('#editorCanvasOutside')

$('#editorCanvasInside').get(0).toBlob(function(blob){
...
$uss=$_GET['username'];
$slc="SELECT * FROM `databox` WHERE `username`='ali' ";
...
$qry=mysqli_query($con,$slc);
    ...
    <input id="outin" type="tex" value="0" style="width:0px; height:0px;visibility: hidden;"/>

<input id="facetop" type="tex" value="0" style="width:0px; height:0px;visibility: hidden;"/>
<input id="faceleft" type="tex" value="0" style="width:0px;height:0px;visibility: hidden;"/>
    ...
    <div id="mydiv" style="position: absolute;box-shadow: #668;left:32.5%;top:35px; width:250px;height: 400px;background-color: #FFf;background-repeat: no-repeat;background-size: cover; z-index: 11000;border:solid 1px #b4b3b3;">
    ...
    <div class="hdsh" style="background-color: #252522;width:90%;height:15%;margin: 4%;border-radius: 5px;cursor: pointer;">
      ...
      <cpan style="position: relative;left:2px;top:20px;" >
        ...
        <div id="BoxConfigOptions">
          <div id="productNameDiv">
             <span class="arrowBtnL" id="arrowBtnL" ><i id="" class="fas fa-arrow-circle-left" style="color: #ccd;"></i></span>
             <span id="productName" style="color: #CCD;">Mailer Box</span>
             <span class="arrowBtnR"id="arrowBtnR"><i id="" class="fas fa-arrow-circle-right" style="color: #ccd;"></i></span>
          </div>
        </div>
...
<!--     part 2 -----------------------------------------                            -->
    ...
    <div id="mydivv" style="position: absolute;right:20px;top: 35px; width:250px;height: 400px;background-color:rgb(214, 214, 212);z-index: 11000;border:solid 1px #b4b3b3;">
      ...
      <div class="hdshh" id="clicktoclick" style="background-color: #fafafa;cursor: pointer; width:90%;height:15%;margin: 4%;border-radius: 5px;">
        ...
        <input id="inpFile" type="file" class="myfile" style="position: relative;height:50px;cursor: pointer;top:-20px;opacity: 1;" />
<button type="submit" id="givimg" style="visibility:hidden;">upload</button>
  </form>
      </div>
      <div id="adtxt_cus" class="hdshh" style="background-color: #fffffffd;width:90%;cursor: pointer;text-align: center; height:15%;margin: 4%;border-radius: 5px;"><span style="position: absolute;left:80px;top:110px; " >ADD Text</span>
...
<input type="color" id='boxbg' style="position:relative;width: 40px;height: 40px; border-radius: 50%;float:left" />
<input type="color" id='boxbgin' style="position:relative;width: 40px;height: 40px; border-radius: 50%;float:right" />
<br>
<br><br>
<br>
<img class="patreenimg"   style="position:relative;width:30%;height:30%" src="pattern/pattern.jpg"/>
<img class="patreenimg"   style="position:relative;width:30%;height:30%" src="pattern/pattern2.jpg"/>
<img class="patreenimg"   style="position:relative;width:30%;height:30%" src="pattern/pattern4.jpg"/>
<img class="patreenimg"   style="position:relative;width:30%;height:30%" src="pattern/pattern6.jpg"/>
<img class="patreenimg"   style="position:relative;width:30%;height:30%" src="pattern/pattern7.jpg"/>
<img class="patreenimg"   style="position:relative;width:30%;height:30%" src="pattern/pattern8.jpg"/>
<img class="patreenimg"   style="position:relative;width:30%;height:30%" src="pattern/pattern9.jpg"/>
<img class="patreenimg"   style="position:relative;width:30%;height:30%" src="pattern/pattern10.png"/>
<img class="patreenimg"   style="position:relative;width:30%;height:30%" src="pattern/pattern11.jpg"/>
      ...
      <div class="hdshh" style="background-color: #fafafa;cursor: pointer; width:90%;height:15%;margin: 1%;border-radius: 5px;width: 93%;height:30%;border: #f7f7f8 solid 2px;">   
        ...
        <img  id="addimg" class="imgtexture"  style="position: relative;cursor: pointer; width:100%;z-index: 8000;height:100%;" src="bg.png"/>
...
<div style="position: absolute;border-radius: 50%; width:40px;height:40px; z-index: 11000;left:5%;top:80%;">
  <i style="position: relative;color: #ccd; color: #EF4B81;" class="fas fa-fill-drip fa-2x"></i><input type="color" id="capcolr" style="position: absolute;border-radius: 50%; width:40px;height:40px; border: rgb(10, 10, 10) solid 5px;z-index: 11000;left:5%;top:80%;background-color: rgb(17, 17, 17);" />
     ...
     <span style="position: relative;top:8px;">Reset</span>
      ...
      <div onclick="caughtpic()" id="restt" style="position: absolute;text-align: center; font-family:fantasy; width:120px;height:40px; border: rgb(58, 58, 58) solid 1px;background-color: #eee6e9;z-index: 11000;left:51.3%;top:80%;border-radius: 20px 20px 20px 20px;">
        <i style="position: relative;top:8px;margin-right:7px;" class="fas fa-save"></i><span style="position: relative;top:8px;">Save</span>
      </div>
      
      <div id="chek" style="position: absolute;text-align: center; width:170px;height:40px; border: rgb(58, 58, 58) solid 1px;background-color: #346ce7;z-index: 11000;left:61.3%;top:80%;border-radius: 20px 20px 20px 20px;">
...
<!---
  ...
  <script src="./assets.dev/js/fabriccodejsn.js" type="text/javascript">
    ...
    <input type="text" id ="facetop" style="position: absolute;left:200px;top:300;z-index:30000;visibility:hidden; " value="right"/>
<br>

<input type="text" id ="bxw"  style="position: absolute;left:10px;top:300;z-index:30000;visibility:hidden;  "/>
<br>
<input type="text" id ="bxh"  style="position: absolute;left:30px;top:500;z-index:30000; visibility:hidden; "/>
<br>
<input type="text" id ="bxwin" value="win"  style="position: absolute;left:50px;top:700;z-index:30000;visibility:hidden;  "/>
<br>
<input type="text" id ="bxhin" value="wout" style="position: absolute;left:70px;top:900;z-index:30000;visibility:hidden;  "/>
<br>
